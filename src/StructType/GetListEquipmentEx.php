...
/**
 * This class stands for GetListEquipmentEx StructType
 * @subpackage Structs
 */
class GetListEquipmentEx extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $Vehicle;
    /**
     * Constructor method for GetListEquipmentEx
     * @uses GetListEquipmentEx::setSettings()
     * @uses GetListEquipmentEx::setVehicle()
     ...
     * Set Settings value
     * @param \Autovista\Specification\StructType\ETGsettingType $settings
     * @return \Autovista\Specification\StructType\GetListEquipmentEx
     */
