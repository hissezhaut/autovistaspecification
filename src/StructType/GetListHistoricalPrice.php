...
/**
 * This class stands for GetListHistoricalPrice StructType
 * @subpackage Structs
 */
class GetListHistoricalPrice extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $Vehicle;
    /**
     * Constructor method for GetListHistoricalPrice
     * @uses GetListHistoricalPrice::setSettings()
     * @uses GetListHistoricalPrice::setVehicle()
     ...
     * Set Settings value
     * @param \Autovista\Specification\StructType\ETGsettingType $settings
     * @return \Autovista\Specification\StructType\GetListHistoricalPrice
     */
