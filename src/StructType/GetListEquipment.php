...
/**
 * This class stands for GetListEquipment StructType
 * @subpackage Structs
 */
class GetListEquipment extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $Vehicle;
    /**
     * Constructor method for GetListEquipment
     * @uses GetListEquipment::setSettings()
     * @uses GetListEquipment::setVehicle()
     ...
     * Set Settings value
     * @param \Autovista\Specification\StructType\ETGsettingType $settings
     * @return \Autovista\Specification\StructType\GetListEquipment
     */
